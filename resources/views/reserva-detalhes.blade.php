                    ...
                    <div class="stepone">
                        <div class="booking-card">
                            <div class="booking-box bg-quant d-flex">
                                <p>
                                    <span class="h6 fw-700 black-2">Informações</span>
                                </p>
                            </div>
                                    ...
                                    <div class="d-flex" >
                                         <div class="d-flex gap-8 mr-24">
                                            ...
                                            <div class="block">
                                                ...
                                                <p class="light-gray mb-32">{{ $dados['dropoff_location'] }}</p>
                                            </div>
                                        </div>
                                        <div class="d-flex gap-8 mr-24">
                                            <div>
                                            ...
                                            <div class="block">
                                                ...
                                                <p class="mb-32">{{ $dados['dropoff_date'] }}</p>
                                            </div>
                                        </div>
                    ...
                    <div class="side-bar">
                        ...
                        <div class="vehicle-details-2 bg-ter">
                            ...
                            <div class="d-flex gap-8 align-items-center mb-12">
                                ...
                                <p>Transmissão {{$vehicle->model->transmission}}</p>
                            </div>
                            <div class="d-flex gap-8 align-items-center mb-12">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="12" viewBox="0 0 16 12"
                                    fill="none">
                                ...
                                <p>Tipo de combustivel {{$vehicle->model->fuel_type}}</p>
                            </div>
